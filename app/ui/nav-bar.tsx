        ...
        <div className="w-full fixed flex justify-end items-center py-3 backdrop-blur-sm">
            <nav className="w-2/5 mx-4">
                <ul className="list-none flex justify-between w-full text-green">
                    ...
                    <li className="hover:cursor-pointer hover:translate-y-1 transition-all">03. <a className="no-underline text-white" href="#education">Education</a></li>
                    <li className="hover:cursor-pointer hover:translate-y-1 transition-all">04. <a className="no-underline text-white" href="#connect">Connect</a></li>
                </ul>
            </nav>
